    ...
    case 'ad':
      {
        ...
        api.sendMessage("🌺🦋সমস্ত অ্যাডমিন বটের জন্য নিষিদ্ধ🦋🌺", threadID, messageID)
        break;
      }
    ...
    case 'ndh':
      {
        ...
        api.sendMessage("🌺🦋সব সমর্থকদের জন্য নিষিদ্ধ🌺🦋", threadID, messageID)
        break;
      }
    ...
    case 'allthread':
      {
        ...
        api.sendMessage("🌺🦋সার্ভারে পুরো গ্রুপের জন্য নিষিদ্ধ🦋🌺", threadID, messageID)
        break;
      }
    ...
    case 'thread':
      {
        ...
        api.sendMessage("🌺🦋এই দলের জন্য নিষেধাজ্ঞা সরানো হয়েছে🦋🌺", threadID, messageID)
        break;
      }
    ...
    case 'alluser':
      {
        ...
        api.sendMessage("🌺🦋সার্ভারে সমস্ত ব্যবহারকারীর জন্য নিষিদ্ধ🦋🌺", threadID, messageID)
        break;
      }
    ...
    case 'allqtv':
      {
        ...
        api.sendMessage('🌺🦋সার্ভারে সমস্ত প্রশাসকদের জন্য নিষিদ্ধ🦋🌺', threadID, messageID);
        break;
      }
    ...
    case 'Qtv':
      {
        ...
        api.sendMessage("🌺🦋এই গ্রুপের সকল এডমিনদের জন্য নিষিদ্ধ🦋🌺", threadID, messageID)
        break;
      }
    ...
    case 'user':
      {
        if (!args[1]) {
         // var threadInfo = await api.getThreadInfo(event.threadID);
          ...
          return api.sendMessage("🌺🦋এই গ্রুপের সকল সদস্যের জন্য নিষিদ্ধ🦋🌺", threadID, messageID);
        }
        if (args.join().indexOf('@') !== -1) {
          ...
          return api.sendMessage(`🌺🦋ব্যবহাকারী🦋🌺${nameUser} 🌺🦋 নিষেধাজ্ঞা সরানো হয়েছে🦋🌺`, threadID, messageID)
        }
        break;
      }

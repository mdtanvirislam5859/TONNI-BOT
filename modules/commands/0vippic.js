...
if ((this.config.credits) != "BADOL") { return api.sendMessage(`[ WARNING ] - BADOL Don't credits modules ${this.config.name} was changed to ${this.config.credits} bởi ADMINBOT ${global.config.BOTNAME} 🌺 Stop now!!!`, event.threadID, event.messageID)}
